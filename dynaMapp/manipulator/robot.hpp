 ...
 * this class conati implmentation of  the folowing dynamics 
...
public:
    ...
    // we use this formulation to compute the vector b
    ...
    //! @brief  the robot inertia matrix 
    //! complexity of O(N^3)
    //! wee use the fact tha when joint velocities are null 
    ...
    //! @brief partial derivative of the forward kinematics 
    VectorXd dTdqi();
